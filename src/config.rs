        ...
        Self {
            ...
            actions: vec![
                ActionItem {
                    ...
                    description: "Быстрая проверка компиляции Rust-проекта".to_string(),
                ...
                ActionItem {
                    ...
                    name: "Open in Explorer".to_string(),
                ...
                ActionItem {
                    id: "sys-ip".to_string(),
                    name: "IP Configuration".to_string(),
                    description: "Показать текущие сетевые адреса".to_string(),
                    category: "System".to_string(),
